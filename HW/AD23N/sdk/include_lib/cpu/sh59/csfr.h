...
typedef struct {
    __RW __u32 CON[15]; // 0-1 used in sh59
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-1 used in sh59
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-1 used in sh59
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-1 used in sh59
    __RW __u32 WREN;
} JL_MPU_TypeDef;
...
#define JL_UUID_BASE                 (csfr_base + map_adr(0x0c, 0x01))
...
typedef struct {
    ...
    __RW __u32 MCFG_CKSEL;
    __RW __u32 MCFG_VROM;
    __RW __u32 MPWR_VROM[0];
} JL_MEMCFG_TypeDef;
#define JL_MEMCFG_BASE                (csfr_base + map_adr(0x0d, 0x00))
#define JL_MEMCFG                     ((JL_MEMCFG_TypeDef *)JL_MEMCFG_BASE)
//*********************************************************************************
//
// j32CPU_sfr
//
