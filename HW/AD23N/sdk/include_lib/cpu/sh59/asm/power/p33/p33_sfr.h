...
#else
#define P33_ACCESS(x) (*(volatile u32 *)(0x7c20000 + 0xc000 + x*4))
#endif
...
#define P3_WDT_CON0                   P33_ACCESS(0x014)
#define P3_WDT_CON1                   P33_ACCESS(0x015)
...
#define P3_OSL_CON0                   P33_ACCESS(0x02d)
#define P3_OSL_CON1                   P33_ACCESS(0x02e)
#define P3_OSL_CON2                   P33_ACCESS(0x02f)
...
#define P3_LS_EN0                     P33_ACCESS(0x0cb)
#define P3_LS_EN1                     P33_ACCESS(0x0cc)
#define P3_LS_EN2                     P33_ACCESS(0x0cd)
...
//............. 0X00F0 - 0X00FF............         FOR CTMU
#define P3_LPCTMU_RES00               P33_ACCESS(0x0f0)
#define P3_LPCTMU_RES01               P33_ACCESS(0x0f1)
#define P3_LPCTMU_RES02               P33_ACCESS(0x0f2)
#define P3_LPCTMU_RES03               P33_ACCESS(0x0f3)
#define P3_LPCTMU_RES04               P33_ACCESS(0x0f4)
#define P3_LPCTMU_RES05               P33_ACCESS(0x0f5)
#define P3_LPCTMU_RES06               P33_ACCESS(0x0f6)
#define P3_LPCTMU_RES07               P33_ACCESS(0x0f7)
#define P3_LPCTMU_RES08               P33_ACCESS(0x0f8)
#define P3_LPCTMU_RES09               P33_ACCESS(0x0f9)
#define P3_LPCTMU_RES0A               P33_ACCESS(0x0fa)
#define P3_LPCTMU_RES0B               P33_ACCESS(0x0fb)
#define P3_LPCTMU_RES0C               P33_ACCESS(0x0fc)
#define P3_LPCTMU_RES0D               P33_ACCESS(0x0fd)
#define P3_LPCTMU_RES0E               P33_ACCESS(0x0fe)
#define P3_LPCTMU_RES0F               P33_ACCESS(0x0ff)

//............. 0X0100 - 0X010F............         FOR CTMU
#define P3_LPCTMU_RES10               P33_ACCESS(0x100)
#define P3_LPCTMU_RES11               P33_ACCESS(0x101)
#define P3_LPCTMU_RES12               P33_ACCESS(0x102)
#define P3_LPCTMU_RES13               P33_ACCESS(0x103)
#define P3_LPCTMU_RES14               P33_ACCESS(0x104)
#define P3_LPCTMU_RES15               P33_ACCESS(0x105)
#define P3_LPCTMU_RES16               P33_ACCESS(0x106)
#define P3_LPCTMU_RES17               P33_ACCESS(0x107)
#define P3_LPCTMU_RES18               P33_ACCESS(0x108)
#define P3_LPCTMU_RES19               P33_ACCESS(0x109)
#define P3_LPCTMU_RES1A               P33_ACCESS(0x10a)
#define P3_LPCTMU_RES1B               P33_ACCESS(0x10b)
#define P3_LPCTMU_RES1C               P33_ACCESS(0x10c)
#define P3_LPCTMU_RES1D               P33_ACCESS(0x10d)
#define P3_LPCTMU_RES1E               P33_ACCESS(0x10e)
#define P3_LPCTMU_RES1F               P33_ACCESS(0x10f)
...
#define P3_VDET_CON0                  P33_ACCESS(0x144)
#define P3_VDET_CON1                  P33_ACCESS(0x145)
#define P3_VDET_CNT0                  P33_ACCESS(0x146)

#define P3_DBG_CON0                   P33_ACCESS(0x148)
#define P3_DBG_CON1                   P33_ACCESS(0x149)
#define P3_FUNC_EN                    P33_ACCESS(0x14a)
#define P3_FUNC_CTL0                  P33_ACCESS(0x14b)
#define P3_FUNC_CTL1                  P33_ACCESS(0x14c)
#define P3_FUNC_CTL2                  P33_ACCESS(0x14d)
...
#define P3_EFUSE_CON3                 P33_ACCESS(0x173)
#define P3_EFUSE_RDAT                 P33_ACCESS(0x174)
#define P3_EFUSE_PU_DAT0              P33_ACCESS(0x175)
#define P3_EFUSE_PU_DAT1              P33_ACCESS(0x176)
#define P3_EFUSE_PU_DAT2              P33_ACCESS(0x177)
#define P3_EFUSE_PU_DAT3              P33_ACCESS(0x178)
#define P3_EFUSE_ANA0                 P33_ACCESS(0x179)
...
#define P3_LS_CON0                    P33_ACCESS(0x1a0)
#define P3_LS_CON1                    P33_ACCESS(0x1a1)
#define P3_LS_CON2                    P33_ACCESS(0x1a2)
#define P3_LS_CON3                    P33_ACCESS(0x1a3)
...
#define P3_RES_LIMH0                  P33_ACCESS(0x1d8)
#define P3_RES_LIMH1                  P33_ACCESS(0x1d9)
#define P3_RES_LIML0                  P33_ACCESS(0x1da)
#define P3_RES_LIML1                  P33_ACCESS(0x1db)

//............. 0X01E0 - 0X01EF............         FOR LPCTMU
#define P3_LPCTMU_CON0                P33_ACCESS(0x1e0)
#define P3_LPCTMU_CON1                P33_ACCESS(0x1e1)
#define P3_LPCTMU_CON2                P33_ACCESS(0x1e2)
#define P3_LPCTMU_CON3                P33_ACCESS(0x1e3)
#define P3_LPCTMU_CON4                P33_ACCESS(0x1e4)
#define P3_LPCTMU_CON5                P33_ACCESS(0x1e5)
#define P3_LPCTMU_CON6                P33_ACCESS(0x1e6)
#define P3_LPCTMU_CON7                P33_ACCESS(0x1e7)
#define P3_LPCTMU_CON8                P33_ACCESS(0x1e8)
#define P3_LPCTMU_CON9                P33_ACCESS(0x1e9)
#define P3_LPCTMU_CONA                P33_ACCESS(0x1ea)
#define P3_LPCTMU_CONB                P33_ACCESS(0x1eb)
#define P3_LPCTMU_RES_POS             P33_ACCESS(0x1ec)
#define P3_LPCTMU_L2_RES_POS          P33_ACCESS(0x1ed)

#define P3_KEY_CON0                   P33_ACCESS(0x1ef)

//............. 0X01F0 - 0X01FF............         FOR RESERVED
#define P3_KEY0                       P33_ACCESS(0x1f0)
#define P3_KEY1                       P33_ACCESS(0x1f1)
#define P3_KEY2                       P33_ACCESS(0x1f2)
#define P3_KEY3                       P33_ACCESS(0x1f3)
#define P3_KEY4                       P33_ACCESS(0x1f4)
#define P3_KEY5                       P33_ACCESS(0x1f5)
#define P3_KEY6                       P33_ACCESS(0x1f6)
#define P3_KEY7                       P33_ACCESS(0x1f7)
#define P3_KEY8                       P33_ACCESS(0x1f8)
#define P3_KEY9                       P33_ACCESS(0x1f9)
#define P3_KEYA                       P33_ACCESS(0x1fa)
#define P3_KEYB                       P33_ACCESS(0x1fb)
#define P3_KEYC                       P33_ACCESS(0x1fc)
#define P3_KEYD                       P33_ACCESS(0x1fd)
#define P3_KEYE                       P33_ACCESS(0x1fe)
#define P3_KEYF                       P33_ACCESS(0x1ff)

//======================================================
//SFR RENAME
//======================================================
//............. LSE SFR ............
#define P3_LS_IO_USR                  P3_LS_CON0
#define P3_LS_IO_ROM                  P3_LS_CON1
#define P3_LS_IO_PINR                 P3_LS_CON2
#define P3_LS_PLL                     P3_LS_CON3
#define P3_LS_WAT                     P3_LS_CON4
#define P3_LS_CLASSD                  P3_LS_CON5
#define P3_LS_ADC                     P3_LS_CON6
#define P3_LS_AUDIO                   P3_LS_CON7

//............. LPCTMU SFR ............
#define P3_LPCTMU_CON                 P3_LPCTMU_CON0
#define P3_LPCTMU_PPRD                P3_LPCTMU_CON3
#define P3_LPCTMU_DPRD0               P3_LPCTMU_CON4
#define P3_LPCTMU_DPRD1               P3_LPCTMU_CON5
#define P3_LPCTMU_WCON                P3_LPCTMU_CON7
#define P3_LPCTMU_PND                 P3_LPCTMU_CON8
#define P3_LPCTMU_WKUP                P3_LPCTMU_CON9

#define P3_LPCTMU_RES0L_ACCESS_ADR    0x0f0
#define P3_LPCTMU_RES0H_ACCESS_ADR    0x0f1
#define P3_LPCTMU_RES0L               P3_LPCTMU_RES00
#define P3_LPCTMU_RES0H               P3_LPCTMU_RES01
#define P3_LPCTMU_RES1L               P3_LPCTMU_RES02
#define P3_LPCTMU_RES1H               P3_LPCTMU_RES03
#define P3_LPCTMU_RES2L               P3_LPCTMU_RES04
#define P3_LPCTMU_RES2H               P3_LPCTMU_RES05
#define P3_LPCTMU_RES3L               P3_LPCTMU_RES06
#define P3_LPCTMU_RES3H               P3_LPCTMU_RES07
#define P3_LPCTMU_RES4L               P3_LPCTMU_RES08
#define P3_LPCTMU_RES4H               P3_LPCTMU_RES09

#define P3_LPCTMU_L2_RES0L_ACCESS_ADR 0x0fa
#define P3_LPCTMU_L2_RES0H_ACCESS_ADR 0x0fb
#define P3_LPCTMU_L2_RES0L            P3_LPCTMU_RES0A
#define P3_LPCTMU_L2_RES0H            P3_LPCTMU_RES0B
#define P3_LPCTMU_L2_RES1L            P3_LPCTMU_RES0C
#define P3_LPCTMU_L2_RES1H            P3_LPCTMU_RES0D
#define P3_LPCTMU_L2_RES2L            P3_LPCTMU_RES0E
#define P3_LPCTMU_L2_RES2H            P3_LPCTMU_RES0F
#define P3_LPCTMU_L2_RES3L            P3_LPCTMU_RES10
#define P3_LPCTMU_L2_RES3H            P3_LPCTMU_RES11
#define P3_LPCTMU_L2_RES4L            P3_LPCTMU_RES12
#define P3_LPCTMU_L2_RES4H            P3_LPCTMU_RES13

#define P3_LPCTMU_ANA0                P3_LPCTMU_CON6
#define P3_LPCTMU_ANA1                P3_LPCTMU_CON1
#define P3_LPCTMU_ANA2                P3_LPCTMU_CON2
