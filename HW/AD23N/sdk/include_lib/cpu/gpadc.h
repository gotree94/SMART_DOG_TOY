...
/**
 * @brief adc_scan_over_callback_regist
 *
 * @return 注册adc队列采集完成后的回调
 */
void adc_scan_over_callback_regist(void (*adc_scan_over_cb)(void));

/**
 * @brief adc_scan_over_callback_regist
 *
 * @return 注销adc队列采集完成后的回调
 */
void adc_scan_over_callback_unregist();
