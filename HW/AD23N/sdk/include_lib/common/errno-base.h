...
#define E_FSCAN_ERR     (0x8020 + 0)

#define E_DECODER     (0X8100 + 1)
#define E_PARG_NULL   (0x8100 + 2)

#define E_ENC_CHN_HAD    (0x8120 + 1)
#define E_ENC_CHN_FULL   (0x8120 + 2)
#define E_ENC_CHN_NOFIND (0x8120 + 3)
#define E_ENC_HDL_NULL   (0x8120 + 4)
...
#define E_MIO_PWM_OUTRANGED    (0x8200 + 9)
#define E_MIO_PWM_USING        (0x8200 + 0xa)
#define E_MIO_IO_OUTRANGED     (0x8200 + 0xb)
#define E_MIO_IO_GROUP_OUTRANGED (0x8200 + 0xc)
...
#define E_F1A_OUTRGE  (0X9000 + 4)
#define E_F1A_RESOURCE  (0X9000 + 5)
...
#define E_SADC_NEW             (0xA010 + 0)
#define E_SADC_WAS_HAD_CH      (0xA010 + 1)
#define E_SADC_ISR_NOT_READY   (0xA010 + 2)
#define E_SADC_CH_TYPE         (0xA010 + 3)
#define E_SADC_CH_NULL         (0xA010 + 4)

#define E_AUADC_NULL          (0xA080 + 0)
#define E_AUADC_MODE          (0xA080 + 1)
#define E_AUADC_ANA_PARAM_NULL (0xA080 + 2)
...
#define E_AUTRIM_RUN_LOW_ERR                    (0xE000 + 0x1)
#define E_AUTRIM_RUN_HIGH_ERR                   (0xE000 + 0x2)
#define E_AUTRIM_ADC_VALUE                      (0xE000 + 0x3)
#define E_AUTRIM_ADC_VALUE_VB17                 (0xE000 + 0x4)
