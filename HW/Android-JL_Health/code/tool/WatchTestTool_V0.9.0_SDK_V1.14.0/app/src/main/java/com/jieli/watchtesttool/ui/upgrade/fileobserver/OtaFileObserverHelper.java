package com.jieli.watchtesttool.ui.upgrade.fileobserver;
...
public class OtaFileObserverHelper {
    ...
    private OtaFileObserverHelper() {
        //设置OTA文件夹路径为观察路径
        watchPath = AppUtil.createFilePath(WatchApplication.getWatchApplication(), WatchTestConstant.DIR_UPDATE);
