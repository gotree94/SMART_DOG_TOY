...
import com.jieli.healthaide.ui.health.step.StepDataFragment;
import com.jieli.healthaide.ui.health.step.StepDayFragment;
import com.jieli.healthaide.ui.health.step.StepMonthFragment;
import com.jieli.healthaide.ui.health.step.StepWeekFragment;
import com.jieli.healthaide.ui.health.step.StepYearFragment;
 ...
 */
public class StepFragment extends HealthDetailHeadFragment {
    ...
    private final Fragment[] mFragments = new Fragment[]{
            StepDayFragment.newInstance(),
            StepWeekFragment.newInstance(),
            StepMonthFragment.newInstance(),
            StepYearFragment.newInstance()
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayoutHealthDetailHeadBinding.tabCalendar.setTabTextColors(getResources().getColor(R.color.white_light_b3), getResources().getColor(R.color.purple_805BEB));
        initView();
    ...
    protected void calendarSelect() {
        ...
        StepDataFragment stepDataFragment = (StepDataFragment) mFragments[currentItem];
        stepDataFragment.calendarSelect();
    }
}