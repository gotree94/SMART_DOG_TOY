...
public class CustomBarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    protected void init() {
        ...
        mRenderer = new CustomBarChartRenderer(this, this, mAnimator, mViewPortHandler);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ((CustomBarChartRenderer) mRenderer).setPointerPosition(this, event);
                break;
    ...
    public float getHighLightXByCurrentPointerPosition() {
        return ((CustomBarChartRenderer) mRenderer).getHighLightXByCurrentPointerPosition();
    }
    ...
    public void setRenderCallback(CustomBarChartRenderer.RenderCallback renderCallback) {
        ((CustomBarChartRenderer) mRenderer).setRenderCallback(renderCallback);
    }
}
