...
public class HeartRateFragment extends HealthDetailHeadFragment {
    ...
    private final Fragment[] mFragments = new Fragment[]{
             HeartRateDayFragment.newInstance(),
             HeartRateWeekFragment.newInstance(),
             HeartRateMonthFragment.newInstance(),
             HeartRateYearFragment.newInstance()
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentHealthDetailHeadBinding.clHealthHeaderMain.setBackground(ContextCompat.getDrawable(requireContext(), R.drawable.bg_heart_rate_fragment));
        initView();
    ...
    protected void calendarSelect() {
        ...
        HeartRateDataFragment heartRateDataFragment = (HeartRateDataFragment) mFragments[currentItem];
        heartRateDataFragment.calendarSelect();
    }
}