...
import com.jieli.healthaide.databinding.FragmentRegisterBinding;
...
public class RegisterFragment extends SmsCodeFragment {
    ...
    private final ActivityResultLauncher<Intent> registerLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
            result -> {
                if (!isFragmentValid() || result.getData() == null || agreePrivacyPolicyView == null)
                    return;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mFragmentBinding = FragmentRegisterBinding.inflate(inflater, container, false);
    ...
    private void initUI() {
        mFragmentBinding.clRegisterTopbar.tvTopbarTitle.setText(R.string.phone_register);
        mFragmentBinding.clRegisterTopbar.tvTopbarRight.setText(R.string.email_register);
    ...
    private final TextWatcher registerStateListener = new CustomTextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            boolean ret = FormatUtil.checkPhoneNumber(mFragmentBinding.layoutSmsCode.etPhoneNumber.getText().toString().trim())
                    && FormatUtil.checkSmsCode(mFragmentBinding.layoutSmsCode.etVerificationCode.getText().toString().trim())
            ...
            mFragmentBinding.btnRegister.setTextColor(getResources().getColor(ret ? R.color.white : R.color.gray_B3B3B3));
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mFragmentBinding.clRegisterTopbar.tvTopbarRight) {
                ...
                ContentActivity.startContentActivityForResult(RegisterFragment.this, EmailRegisterFragment.class.getCanonicalName(),
                        bundle, registerLauncher);
//                requireActivity().finish();
                ...
                if (!isAgree) {
                    showTips(R.string.check_policy_status_tips);
                    return;
                }
