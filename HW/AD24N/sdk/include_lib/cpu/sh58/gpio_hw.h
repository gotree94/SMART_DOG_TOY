...
enum OUTPUT_CH_SIGNAL {
    ...
    // OCH_MCPWM2_L,
    OCH_CLOCK_OUT0,
    OCH_DISABLE0,// OUTPUT_CH_SIGNAL_CLOCK_OUT1,//sh58无clk out1
    OCH_CLOCK_OUT2,
    OCH_P33_CLK_DBG,
    OCH_P33_SIG_DBG0,
    OCH_P33_SIG_DBG1,
...
enum gpio_function {
    ...
    PORT_FUNC_OCH_RESERVED0,//不连续 PORT_FUNC_OCH_CLOCK_OUT1,
    ...
    PORT_FUNC_OCH_PLNK_CLK,
    PORT_FUNC_ICH_PLNK_DAT0,
    PORT_FUNC_ICH_PLNK_DAT1,
};
/**************************************************/
