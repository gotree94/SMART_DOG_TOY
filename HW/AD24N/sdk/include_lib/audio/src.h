...
enum SRC_CMD {
    SRC_CMD_NONE = 0,
    SRC_CMD_INSR_SET,
    SRC_CMD_INSR_INC_SET,		//输入采样率点数增加
    SRC_CMD_GET_WORKBUFF_LEN_AND_TYPE,
    SRC_CMD_BUILD_TIME_GET,
    SRC_CMD_INSR_INC_INIT,		//设置输入采样率点数
    SRC_CMD_GET_INSAMPLE,		//获取输入采样率
    SRC_CMD_GET_OUTSAMPLE,  	//获取输出采样率
    SRC_CMD_GET_INSAMPLE_INC,	//获取输入采样率累加点数
