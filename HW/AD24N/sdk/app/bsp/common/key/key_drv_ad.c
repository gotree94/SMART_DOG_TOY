...
void ad_key_init(void)
{
    ...
    gpio_hw_set_die(IO_PORT_SPILT(adc_ch2port(AD_KEY_CH)), 0);
    gpio_hw_set_direction(IO_PORT_SPILT(adc_ch2port(AD_KEY_CH)), 1);
    gpio_hw_set_pull_down(IO_PORT_SPILT(adc_ch2port(AD_KEY_CH)), 0);
#if EXTERN_R_UP
    gpio_hw_set_pull_up(IO_PORT_SPILT(adc_ch2port(AD_KEY_CH)), 0);
#else
    gpio_hw_set_pull_up(IO_PORT_SPILT(adc_ch2port(AD_KEY_CH)), 1);
#endif
