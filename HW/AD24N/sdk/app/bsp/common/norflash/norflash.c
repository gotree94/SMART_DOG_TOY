...
#define spi_init()              spi_open(_norflash.spi_num, get_hw_spi_config(SPI_HW_NUM))
#define spi_closed()            spi_deinit(_norflash.spi_num)
#define spi_suspend()           spi_suspend(_norflash.spi_num)
...
__no_cache1:
    ...
    if (_norflash.spi_r_width == SPI_MODE_UNIDIR_2BIT) {
        ...
        log_error("flash write error!SPI1/2 don't support 4BIT!");
        /* spi_write_byte(0x6b); */
        /* _norflash_send_addr(addr); */
        /* spi_write_byte(0); */
