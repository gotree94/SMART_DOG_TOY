...
-(void)initUI{
    ...
    label0.contentMode = UIViewContentModeCenter;
    ...
    labelFunOne.contentMode = UIViewContentModeCenter;
    ...
    [slider1 setThumbImage:[UIImage imageNamed:@"slider_nol"] forState:UIControlStateNormal];
    ...
    labelFunTwo.contentMode = UIViewContentModeCenter;
    ...
    [slider2 setThumbImage:[UIImage imageNamed:@"slider_nol"] forState:UIControlStateNormal];
