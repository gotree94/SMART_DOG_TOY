...
- (NSArray *)getYearArr {
    ...
    for (NSInteger i = 1900; i <= self.maxDate.br_year; i++) {
...
- (NSArray *)setupPickerUnitLabel:(UIPickerView *)pickerView unitArr:(NSArray *)unitArr {
    ...
    for (NSInteger i = 0; i < pickerView.numberOfComponents; i++) {
        ...
        unitLabel.font = [UIFont fontWithName:@"PingFangSC" size:15];//self.pickerStyle.dateUnitTextFont;
        unitLabel.textColor = [UIColor colorWithRed:36.0/255.0 green:36.0/255.0 blue:36.0/255.0 alpha:1.0];//self.pickerStyle.dateUnitTextColor;
        // 字体自适应属性
