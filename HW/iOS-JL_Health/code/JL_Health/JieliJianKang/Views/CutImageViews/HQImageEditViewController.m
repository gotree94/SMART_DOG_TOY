...
-(UIButton *)existBtn{
    if (!_existBtn) {
        ...
        [_existBtn setImage:[UIImage imageNamed:@"icon_return_nol_white"] forState:UIControlStateNormal];
...
- (UIButton *)rotateButton {
    if (!_rotateButton) {
        ...
        [_rotateButton setImage:[UIImage imageNamed:@"icon_revolve_nol"] forState:UIControlStateNormal];
        _rotateButton.tag = 0;
