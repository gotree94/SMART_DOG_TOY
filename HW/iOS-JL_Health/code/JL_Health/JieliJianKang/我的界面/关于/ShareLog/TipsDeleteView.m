...
-(void)initUI{
    ...
    _mainLab.font = [UIFont boldSystemFontOfSize:16];
    _mainLab.textColor = [JLColor colorWithString:@"#242424"];
    ...
    [_cancelBtn setTitleColor:[JLColor colorWithString:@"#558CFF"] forState:UIControlStateNormal];
    [_cancelBtn setTitleColor:[JLColor colorWithString:@"#A4A4A4"] forState:UIControlStateHighlighted];
    ...
    [_confirmBtn setTitleColor:[JLColor colorWithString:@"#A4A4A4"] forState:UIControlStateHighlighted];
    ...
    _line0 = [UIView new];
    _line0.backgroundColor = [JLColor colorWithString:@"#F5F5F5"];
    [_centerView addSubview:_line0];
    _line1 = [UIView new];
    _line1.backgroundColor = [JLColor colorWithString:@"#F5F5F5"];
